...
class HANConv(torch.nn.Module):
    r"""The Heterogeneous Graph Attention Network (HAN) model, as introduced in the
    `"Heterogeneous Graph Attention Network" <https://arxiv.org/abs/1903.07293>`__ paper.
    
    This model leverages the power of attention mechanisms in the context of heterogeneous graphs,
    allowing for the learning of node representations that capture both the structure and the
    multifaceted nature of the graph.
    ...
    Args:
        ...
        heads (int, optional): Number of multi-head-attentions, the default values is 1.
    ...
    def forward(self, 
        ...
        # For different edges, we use corresponding GAT to capture graph information.
        ...
        # For different GAT convolution outputs, we use attention to fuse features.
        semantic_attn_dict = {}
