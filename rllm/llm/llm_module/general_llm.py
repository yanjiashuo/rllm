...
class LLM(BaseLLM):
    ...
    def __init__(
        ...
        self.messages_to_prompt = messages_to_prompt or default_messages_to_prompt
        self.completion_to_prompt = completion_to_prompt or default_completion_to_prompt
