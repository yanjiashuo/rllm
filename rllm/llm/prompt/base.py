...
from rllm.llm.prompt.utils import get_template_vars, prompt_to_messages, messages_to_prompt
...
class BasePromptTemplate(ABC):
    ...
    def _map_function_vars(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        """For keys in function_mappings, compute values and combine with kwargs.
