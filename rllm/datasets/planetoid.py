...
class PlanetoidDataset(Dataset):
    r"""The citation network datasets from the `Revisiting Semi-Supervised Learning with Graph
    Embeddings <https://arxiv.org/abs/1603.08861>`__ paper, which include :obj:`"Cora"`, :obj:`"CiteSeer"` and :obj:`"PubMed"`. 
    ...
    def process(self):
        ...
        if self.name == 'citeseer':
            ...
            # We should find them and add them as zero-vector in the right position.
        ...
        data = GraphData(x, y, adj_sp, train_mask=train_mask, val_mask=val_mask, test_mask=test_mask)
