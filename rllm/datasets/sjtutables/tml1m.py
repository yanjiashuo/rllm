...
class TML1MDataset(Dataset):
    r"""TML1MDataset is a multi-table relational dataset containing three tables,
    ...
    The users table includes information about users, such as gender and occupation.
    The movies table contains information about movies, such as duration and plot.
    The ratings table represents the interaction information between the user and movie tables.
    In addition, the embeddings of movies table using all-MiniLM-L6-v2 model are also provided.
    ...
    .. parsed-literal::
        ...
        ------------------
            ...
            nodes       1,000,209   4   
    """
    url = "https://raw.githubusercontent.com/rllm-project/rllm_datasets/main/sjtutables/TML1M.zip"
