...
class TLF2KDataset(Dataset):
    r"""TLF2KDataset is a multi-table relational dataset containing three tables,
    ...
    The artists table includes information about artists, such as location and genre.
    The user_artists table contains the interaction between the user and artist as format: 
    [user, artist, listening_count]. 
    The user_friends table represents the bi-directional edge friendship between users.
    ...
    .. parsed-literal::
        ...
        ------------------
            ...
            nodes       12,717      2   
    """
    url = "https://raw.githubusercontent.com/rllm-project/rllm_datasets/main/sjtutables/TLF2K.zip"
