...
class TACM12KDataset(Dataset):
    r"""TACM12KDataset is a multi-table relational dataset containing four tables,
    ...
    The papers table includes the publication information of papers.
    The authors table includes the author information.
    The citations table includes the citation (i.e., <paper, paper>) information between papers.
    The writings table includes the <author, write, paper> relationship between authors and papers.
    ...
    url = "https://raw.githubusercontent.com/rllm-project/rllm_datasets/main/sjtutables/TACM12K.zip"
    ...
    def raw_filenames(self):
        return ['papers.csv', 'authors.csv', 'citations.csv', 'writings.csv', 'masks.pt']

    @property
    def processed_filenames(self):
        return ['paper_data.pt', 'author_data.pt', 'cite_data.pt', 'write_data.pt']
